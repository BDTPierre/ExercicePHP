<?php
$cars = array (
    array("id"=>1,"prenom"=>"Mr. Pierre","model"=>"Volvo","vendu"=>22,"stock"=>18),
    array("id"=>2,"prenom"=>"Mr. Paul","model"=>"BMW","vendu"=>33,"stock"=>5),
    array("id"=>3,"prenom"=>"Mme. Camille","model"=>"Saab","vendu"=>3,"stock"=>88),
    array("id"=>4,"prenom"=>"Mme. Imen","model"=>"Land Rover","vendu"=>45,"stock"=>2),
    array("id"=>5,"prenom"=>"Mr. Amine","model"=>"Land Rover","vendu"=>45,"stock"=>2),
);
